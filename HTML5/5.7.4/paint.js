...
function canvasApp(){  
	...
	/* Cambia el tamaño del punter */
	var sizeEvent = document.getElementById("size");
	var size = 10;
	sizeEvent.addEventListener('input', changeSize, false);
    ...
    function mouse_moved(e) {
	  ...
	  x = e.pageX - theCanvas.offsetLeft;
	  y = e.pageY - theCanvas.offsetTop;
	  if (begin_drawing) {
	    context.beginPath();
